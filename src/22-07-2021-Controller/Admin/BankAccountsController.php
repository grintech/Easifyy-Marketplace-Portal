...
class BankAccountsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('The bank account could not be saved. Please, try again. sdsds'));
        }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            $this->Flash->error(__('The bank account could not be saved. Please, try again. 121'));
        }
        $merchants = $this->BankAccounts->Merchants->find('list', ['limit' => 200]);
        $this->set(compact('bankAccount', 'merchants'));
    }
