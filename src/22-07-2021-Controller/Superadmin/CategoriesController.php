...
class CategoriesController extends AppController
{
    ...
    public function index()
    {
        ...
        ->where(['Categories.delete_status'=>1,])
        ->contain(['ParentCategories']); 
    ...
    public function add()
    {
        ...
        $parentCategories = $this->Categories->ParentCategories->find('list', array('conditions'=>array('delete_status'=>1), ['limit' => 200]));
        $this->set(compact('category', 'parentCategories'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $oldcategory = $this->Categories->get($id, [
            'contain' => [],
        ]);
