...
class ProductsController extends AppController
{
    ...
    public function view($id = null)
    {
        $product = $this->Products->get($id, [
            'contain' => ['ProductTypes', 'ParentProducts', 'CartItems', 'MerchantProducts', 'OrderItems', 'ProductBrands', 'ProductBundledItems', 'ProductCategories', 'ProductGalleries', 'ChildProducts'],
        ]);
