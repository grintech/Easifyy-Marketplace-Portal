...
class OrdersController extends AppController
{
    ...
    public function review() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Reviews->save($review)) {
                ...
                $msg .= 'Hello';
                $msg .= '<br>';
                $msg .= 'Order Marks Complete having order ID'.' '.$this->request->getData('order_id');
                $msg .= '<br>';
                $msg .= 'Thanks & Regards';
                $msg .= 'Easifyy';
                ...
                $email
                    ...
                    ->subject('PSP Mark Order Completed')
                    ->send($msg);
    ...
    public function superadminnotes() {
        ...
        $msg .= '<br>';
        $msg .= 'Payment Reason#'.' '.$_POST['prefix'];
        $msg .= '<br>';
        $msg .= 'Amount Requested'.' '.$_POST['amount'];
        $msg .= '<br>';
        $msg .= 'Thanks';
        ...
        $email
            ...
            ->subject('Please clear the payment Order ID'.' '.base64_decode($_POST['order_id']))
            ->send($msg);
    ...
    public function cancelRequest(){
        ...
        if ($this->request->is('post')) {
            ...
            $email
                ...
                ->setViewVars(
                            [
                                'vendor' => $order->merchant->store_name,
                                'job_title' => $order->product->title,
                                'job_price' => $order->gross_total,
                                'paid_Amt' => $order->total,
