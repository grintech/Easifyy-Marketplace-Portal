...
class OrderController extends AppController
{
    ...
    public function checkPaymentStatus(){
        ...
        if ($success === true)
        {
            ...
            $this->assignMerchant($all_order_data);         
            ...
            $session = $curYear = date("Y")."-".date("y",strtotime("+1 year"));
    ...
    public function review() {
        ...
        if ($this->request->is('post')) {
            ...
            $orderNotification->type="order-reject-by-user";
            $orderNotification->message="Order Reject By User";
            $orderNotification->viewed_status= 0; 
            $this->Notifications->save($orderNotification);
            ...
            $msg .= 'Hello';
            $msg .= '<br>';
            $msg .= 'Order Reject By User order ID'.' '.$order_id;
            $msg .= '<br>';
            $msg .= 'Thanks & Regards';
            $msg .= 'Easifyy';
