...
class OrdersController extends AppController
{
    ...
    public function paymentsPSP() {
        ...
        // $status = $_POST['status'];
         ...
         if($_POST['status']=='reject') {
            $payment_status=0;
            $pStatus="Declined";
            $paymentReply ='Your Payment request has been rejected';
         } else {
            $payment_status=1;
            $pStatus="Approved";
            $paymentReply= 'Your Payment request has been accepted ';
         }
    ...
    public function sendInvoicePDF() {
        ...
        $invoiceNo=$invoice."".strtoupper($order->merchant->store_name)."/EASIFYY";
