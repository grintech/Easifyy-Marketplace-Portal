...
class MerchantProductsController extends AppController
{
    ...
    public function view($id = null)
    {
        $merchantProduct = $this->MerchantProducts->get($id, [
            'contain' => ['Merchants', 'Products', 'ProductTypes', 'ParentMerchantProducts', 'MerchantProductBrands', 'MerchantProductBundledItems', 'MerchantProductCategories', 'MerchantProductGalleries', 'ChildMerchantProducts', 'PurchaseItems'],
        ]);
