 ...
 * @method \App\Model\Entity\ProductBrand|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ProductBrand saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
