    ...
    <div class="row justify-content-center mt-0">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center pt-3 mt-0 mb-2">
            <div class="card px-0 pt-0 pb-0 mt-0 mb-0">
                <h5><strong>Activate Existing Professional Service</strong></h5>
                <!--<p>Select fields to go to next step</p>-->
                <div class="row mx-0">
                    <div class="col-md-12 mx-0">
                        <!--<?//= $this->Form->create() ?>-->
                        <?= $this->Form->create(null,array('url'=>'/admin/merchant-products/activate-service','id' => 'activate-service')) ?>
                            <!-- progressbar -->
                            <ul id="progressbar">
                                <li class="active" id="account"><strong>Select Service Category</strong></li>
                            ...
                            <!-- fieldsets -->
                            <fieldset>
                                <h5 class="text-voilet-dark m-0 font-weight-bold">Select Service Category & Choose service you can provide to clients</h5>
                                ...
                                <div class="form-card service-select-form">
                                    ...
                                    <?php echo $this->Form->control('subCategory_id', array('type'=>'select', 'id'=>'Subcategory_id','required' => "required",'div' => false, 'label' => false,'class' => "",'options'=>$subCategories) ); ?>
                                    <?php echo $this->Form->control('title', array('type'=>'select', 'id'=>'title','required' => "required",'div' => false, 'label' => false,'class' => "",'options'=>$subCategories) ); ?>
                                    <label class="px-3"> About this Plan</label>
                                    <textarea  readonly name="description" required="required" placeholder="" class="form-control" rows="5" id="ProductDescription" ></textarea>    
                                    <label class="px-3"> Service Inclusions</label>
                                    <textarea hidden readonly name="inclusions" required="required" placeholder="" class="form-control" rows="5" id="ProductInclusions" ></textarea>    
                                    <ol id="Inclusions" class="px-3 serviceIncList">
                                    </ol>
                                </div> 
                                <button type="button" name="next" class="next action-button" id="activate-service-next" >Save & Continue <i class="fa fa-angle-right" aria-hidden="true"></i></button>
                            </fieldset>
                            <fieldset>
                                        ...
                                        <div class="card-body py-1" >
                                            ...
                                            <div class="card-text row w-100 float-left border rounded p-2 bg-dark-gray">
                                                <div class="card-text row w-100 float-left ">
                                                   ...
                                                   <a class="tax-amt text-voilet-dark  toolhover" href="#" data-container="body" data-toggle="tooltip" data-placement="top" title=""> 
                                                        Service Provider Fee &amp; Charges <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                    </a>
                                                ...
                                                <div class="card-text row w-100 float-left ">
                                                    <h6 class="col-md-12 text-center" >
                                                    <a grid="" background="#000000" title="" style="" data-placement="right" data-toggle="tooltip" data-container="body" href="#" class="tax-amt text-voilet-dark  toolhover">  
                                                        Any Amount For Govt. Payments <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                    </a>
                                                    <span class="tooltip1 right">
                                            ...
                                            <div class="card-text row w-100 float-left  mt-1 py-2">
                                                <div class="col-md-12 text-center font-weight-bold gst-18-div" >
                                            ...
                                            <div class="card-text row w-100 float-left border rounded p-2 bg-dark-gray">
                                                ...
                                                <div class="card-text row w-100 float-left">
                                                    ...
                                                    <div class="card-text row w-100 float-left">
                                                        ...
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_basic_booking_price" value="0" placeholder="Enter Booking Amt." class="form-control _basic_booking_price col-md-12 input-sm-height bg-voilet onlyNo" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_standard_booking_price"  value="" placeholder="Enter Booking Amt." class="form-control _standard_booking_price col-md-12 input-sm-height bg-voilet onlyNo" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-4">
                                                            <input name="_premium_booking_price" value="" placeholder="Enter Booking Amt." class="form-control _premium_booking_price col-md-12 input-sm-height bg-voilet onlyNo" required="required" type="text">  
                                                        </div>
                                                    </div>
                                                    <div class="card-text row w-100 float-left">
                                                        <div class="col-md-3 py-2 font-weight-bold">
                                                        ...
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input id="_basic_plan_time" name="_basic_plan_time" maxlength="3" pattern="\d{3}" value="" placeholder="Enter Delivery Time" class="form-control col-md-12 input-sm-height bg-voilet onlyNo" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input id="_standard_plan_time" name="_standard_plan_time"  maxlength="3" pattern="\d{3}" value="" placeholder="Enter Delivery Time" class="form-control col-md-12 input-sm-height bg-voilet onlyNo" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-4">
                                                            <input id="_premium_plan_time" name="_premium_plan_time" maxlength="3" pattern="\d{3}" value="" placeholder="Enter Delivery Time" class="form-control col-md-12 input-sm-height bg-voilet onlyNo" required="required" type="text">  
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="fs-title text-center"> 
                                        <a name="previous" id="preview-Service" href="#" class="btn">Preview Service</a>
                                    </div> 
                                  &nbsp; &nbsp;
