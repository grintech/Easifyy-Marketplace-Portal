                    ...
                    <div class="col-md-12 mx-0">
                        <form id="msform" >
                            ...
                            <ul id="progressbar">
                                ...
                                <li id="personal"><strong>Service Images</strong></li>
                            ...
                            <fieldset>
                                <div class="form-card py-1 px-2">
                                    <div class="card my-1">
                                        <h6 class="card-header  m-0 bg-voilet-dark" style="color: white;">
                                            <div class="container">
                                                <div class="row ">
                                                    <div class="col-sm">
                                                    Basic Plan 
                                    ...
                                    <div class="card my-1">
                                        <div class="card-body py-1" >
                                            <div class="card-text row w-100 float-left ">
                                                ...
                                                <h6 class="col-md-2 text-center px-2 mx-5">
                                                    Standard Price
                                            ...
                                            <div class="card-text row w-100 float-left border rounded p-2 bg-dark-gray">
                                                ...
                                                <?php if (!is_null($product->product_seller_plans)){ 
                                                    ...
                                                    <?php       } 
                                                            ...
                                                            <div class="non-taxable-row row w-100">
                                                                <div class="col-md-3">
                                                                    <input name="heading[]" value="" placeholder="Enter heading" class="form-control col-md-12 input-sm-height bg-voilet" required="required" type="text">  
                                                                </div>
                                                                <div class="col-md-2 px-2 mx-5">
                                                ...
                                                <div class="card-text row w-100 float-left  mt-1">
                                                    ...
                                                    <div class="col-md-2 px-2 mx-5">
                                                        <input readonly name="total_basic_amt" value="" placeholder="0" class="form-control col-md-12 total_basic_amt input-sm-height"  type="text">  
                                                    </div>
                                                    <div class="col-md-2 px-2 mx-5">
                                                        <input readonly name="total_std_amt"  value="" placeholder="0" class="form-control col-md-12 total_std_amt input-sm-height"  type="text">  
                                                    </div>
                                                    <div class="col-md-2 px-2 mx-5">
                                                        <input readonly name="total_pre_amt" value="" placeholder="0" class="form-control col-md-12 total_pre_amt input-sm-height"  type="text">  
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-text row w-100 float-left border rounded p-2 bg-dark-gray">
                                                <div class="card-text row w-100 float-left mt-1 gst-div">
                                                    <div class="col-md-3 py-2 font-weight-bold">
                                                        GST @ 18 %
                                                    </div>
                                                    <div class="col-md-2 px-2 mx-5">
                                                ...
                                                <div class="card-text row w-100 float-left">
                                                    ...
                                                    <div class="card-text row w-100 float-left">
                                                        ...
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_basic_booking_price" value="<?= ($product->_basic_booking_price)?:'' ?>" placeholder="Enter Booking Amount" class="form-control col-md-12 input-sm-height bg-voilet " required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_standard_booking_price"  value="<?= ($product->_standard_booking_price)?:'' ?>" placeholder="Enter Booking Amount" class="form-control col-md-12 input-sm-height bg-voilet" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-5">
                                                    ...
                                                    <div class="card-text row w-100 float-left">
                                                        ...
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_basic_plan_time" value="<?= ($product->_basic_plan_time)?:'' ?>" placeholder="Enter Deliver Time" class="form-control col-md-12 input-sm-height bg-voilet" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_standard_plan_time"  value="<?= ($product->_standard_plan_time)?:'' ?>" placeholder="Enter Deliver Time" class="form-control col-md-12 input-sm-height bg-voilet" required="required" type="text">  
                                                        </div>
                                                        <div class="col-md-2 px-2 mx-5">
                                                            <input name="_premium_plan_time" value="<?= ($product->_premium_plan_time)?:'' ?>" placeholder="Enter Deliver Time" class="form-control col-md-12 input-sm-height bg-voilet" required="required" type="text">  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-text row w-100 float-left  mt-1">
                                            ...
                                            <div class="card-text row w-100 float-left border rounded p-2 bg-dark-gray">
                                                ...
                                                <div class="card-text row w-100 float-left  mt-1">
                                                    ...
                                                    <div class="col-md-2 px-2 mx-5">
                                                        <input readonly name="total_basic_payable" value="" placeholder="0" class="form-control col-md-12 total_basic_payable input-sm-height"  type="text">  
                                                    </div>
                                                    <div class="col-md-2 px-2 mx-5">
                                                        <input readonly name="total_std_payable"  value="" placeholder="0" class="form-control col-md-12 total_std_payable input-sm-height"  type="text">  
                                                    </div>
                                                    <div class="col-md-2 px-2 mx-5">
                                                        <input readonly name="total_pre_payable" value="" placeholder="0" class="form-control col-md-12 total_pre_payable input-sm-height"  type="text">  
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
