        ...
        <div class="row justify-content-center mt-0">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center pt-3 mt-0 mb-2">
                <div class="card px-0 pt-0 pb-0 mt-0 mb-0">
                    <h5><strong>My Profile Preview</strong></h5>
                    ...
                    <div class="row mx-0">
                        <div class="col-md-12 mx-0">
                            ...
                            <ul id="progressbar">
                                ...
                                <li id="guidelines"><strong>SOP & Mandatory Guidelines</strong></li>
                            ...
                            <fieldset>
                                <div class="form-card service-select-form">
                                    ...
                                    <?php echo $this->Form->control('phone_2', array( 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Alternate Number', 'div' => false , 'required' ,'readonly')); ?>
                                    <h5 class="col-md-12 text-center text-voilet-dark">Billing Business Details</h5>
                                    <?php echo $this->Form->control('service_profession', array('id'=>'service_profession', 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Profession', 'div' => false ,'readonly' )); ?>
                                    <?php echo $this->Form->control('billing_name', array( 'id'=>'billing_name','class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => "Service Provider/Firm Name *", 'div' => false ,'readonly' )); ?>
                                    <?php echo $this->Form->control('address_line_1', array( 'id'=>'address_line_1','class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Address line 1 *', 'div' => false , 'required' ,'readonly')); ?>
                                    <?php echo $this->Form->control('address_line_2', array( 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Address line 2', 'div' => false ,'readonly' )); ?>
                                    <?php echo $this->Form->control('state_id', array('type'=>'select', 'id'=>'states1','required' => "required",'div' => false, 'label' => 'State *','class' => "browser-default",'options'=>$states  ,'readonly','disabled') ); ?>
                                    <?php echo $this->Form->control('city_id', array('type'=>'select', 'id'=>'city-id1','required' => "required",'label' => 'City *','div' => false, 'class' =>"browser-default",'options'=>$cities  ,'readonly','disabled') ); ?>
                                    <?php echo $this->Form->control('zip_code', array('id'=>'zip_code', 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'PIN Code *', 'div' => false , 'required' ,'readonly','disabled')); ?>

                                    <?php echo $this->Form->control('pan_number', array('id'=>'pan_number', 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Pan Number *', 'div' => false  ,'readonly')); ?>
                                    <?php echo $this->Form->control('gst_number', array('id'=>'gst_number', 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'GSTIN Number', 'div' => false ,'readonly' )); ?>
                                    <?php echo $this->Form->control('license_number', array('id'=>'license_number', 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Practising Reg./Licence No.', 'div' => false ,'readonly' )); ?>
                                    <?php echo $this->Form->control('cin_number', array( 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'CIN Number', 'div' => false ,'readonly' )); ?>
                                    <?php echo $this->Form->control('institute_name', array('id'=>'institute_name', 'class' => 'form-control col-md-12', 'placeholder' => __(''), 'label' => 'Name of Institute', 'div' => false  ,'readonly')); ?>

                                    <?= $this->Form->end() ?>
                                </div>
                                <button type="button" name="next" class="profile-next action-button"> Next <i
                            ...
                            <fieldset>
                                <div class="form-card service-select-form">
                                    ...
                                    <?php echo $this->Form->control('account_number', array( 'class' => 'form-control col-md-12', 'placeholder' => __('Account Number'), 'label' => 'Account Number *', 'div' => false , 'required','readonly')); ?>
                                    <?php echo $this->Form->control('account_number_confirm', array( 'class' => 'form-control col-md-12', 'placeholder' => __('Confirm Account Number'), 'label' => 'Confirm Account Number *', 'div' => false , 'required','readonly')); ?>
                                    <?php echo $this->Form->control('account_holder', array( 'class' => 'form-control col-md-12', 'placeholder' => __('Account Holder Name'), 'label' => 'Account Holder Name *', 'div' => false , 'required','readonly')); ?>
                                    <?php echo $this->Form->control('account_type', array('type'=>'select', 'id'=>'account_type','required' => "required",'div' => false, 'label' => 'Select Account Type *','class' => "",'readonly','disabled','options'=>array('Saving' => __('Saving'), 'Current' => __('Current') ) ) ); ?>
                                    <?php echo $this->Form->control('bank_name', array( 'class' => 'form-control col-md-12', 'placeholder' => __('Bank Name'), 'label' => 'Bank Name *', 'div' => false , 'required','readonly')); ?>
                                    <?php echo $this->Form->control('bank_branch', array( 'class' => 'form-control col-md-12', 'placeholder' => __('Branch Address'), 'label' => 'Branch Address *', 'div' => false,'readonly' )); ?>
                                    <?php echo $this->Form->control('ifsc_code', array( 'class' => 'form-control col-md-12', 'placeholder' => __('IFSC Code'), 'label' => 'IFSC Code *', 'div' => false , 'required','readonly')); ?>
                                    <?php echo $this->Form->control('micr_code', array( 'class' => 'form-control col-md-12', 'placeholder' => __('MICR Code'), 'label' => 'MICR Code', 'div' => false,'readonly' )); ?>
                                    <?= $this->Form->end() ?>
                                </div>
                                ...
                                <button type="button" id="bank-settings-btn" name="next" class="action-button"> Next <i
                                        class="fa fa-angle-right" aria-hidden="true"></i></button>
                            </fieldset>
                            <fieldset>
                                <div class="form-card service-select-form">
                                    ...
                                    <div class="row">
                                        <div class="card-text w-80 col-md-9 float-left p-1">
                                            ...
                                            <span>
                                                <!-- <input type="file" name="govt_Id"  value="<?= ($merchantKyc->govt_Id)?:'' ?>" required>-->
                                            </span>
                                        </div>
                                        <?php if($merchantKyc->govt_Id!="") {?>
                                        <a class=" col-md-3 pt-3"
                                            href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->govt_Id?>"
                                            download><i class="fa fa-download"></i> <?=$merchantKyc->govt_Id?></a>
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-9 float-left p-1">
                                            ...
                                            <span>
                                                <!--<input type="file" name="address_Id" value="<?= ($merchantKyc->address_Id)?:'' ?>" required >-->
                                            </span>
                                        </div>
                                        <?php if($merchantKyc->address_Id!="") {?>
                                        <a class=" col-md-3  pt-3"
                                            href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->address_Id?>"
                                            download><i class="fa fa-download"></i> <?=$merchantKyc->address_Id?></a>
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-9 float-left p-1">
                                            ...
                                            <span>
                                                <!--<input type="file" name="qualification_Id" value="<?= ($merchantKyc->qualification_Id)?:'' ?>" >-->
                                            </span>
                                        </div>
                                        <?php if($merchantKyc->qualification_Id!="") {?>
                                        <a class=" col-md-3 pt-3"
                                            href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->qualification_Id?>"
                                            download><i class="fa fa-download"></i>
                                            <?=$merchantKyc->qualification_Id?></a>
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-9 float-left p-1">
                                            ...
                                            <p></p>
                                            <span>
                                                <!--<input type="file" name="gst_declarartion"  value="<?= ($merchantKyc->gst_declarartion)?:'' ?>" >-->
                                            </span>
                                        </div>
                                        <?php if($merchantKyc->gst_declarartion!="") {?>
                                        <a class=" col-md-3 pt-3"
                                            href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->gst_declarartion?>"
                                            download><i class="fa fa-download"></i>
                                            <?=$merchantKyc->gst_declarartion?></a>
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-9 float-left p-1">
                                            ...
                                            <p></p>
                                            <span>
                                                <!--<input type="file" name="gst_declarartion"  value="<?= ($merchantKyc->bank_cheque)?:'' ?>" >-->
                                            </span>
                                        </div>
                                        <?php if($merchantKyc->bank_cheque!="") {?>
                                        <!--<img class="w-20 col-md-2 px-0 py-4" src="../../img/kyc-documents/<?=$merchantKyc->bank_cheque ?>" width="200px"></img>-->
                                        <a class=" col-md-3 pt-3"
                                            href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->bank_cheque?>"
                                            download><i class="fa fa-download"></i> <?=$merchantKyc->bank_cheque?></a>
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-9 float-left p-1">
                                            ...
                                            <p></p>
                                            <span>
                                                <!--<input type="file" name="gst_declarartion"  value="<?= ($merchantKyc->signature)?:'' ?>" >-->
                                            </span>
                                        </div>
                                        <?php if($merchantKyc->signature!="") {?>
                                        <!--<img class="w-20 col-md-2 px-0 py-4" src="../../img/kyc-documents/<?=$merchantKyc->signature ?>" width="200px"></img>-->
                                        <a class=" col-md-3 pt-3"
                                            href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->signature?>"
                                            download><i class="fa fa-download"></i> <?=$merchantKyc->signature?></a>
                                        <?php }?>
                                    </div>
                                ...
                                <button type="button" name="previous" class="previous action-button-previous"><i
                                        class="fa fa-angle-left" aria-hidden="true"></i> Previous</button>
                                <button type="button" id="kyc-btn" name="next" class="profile-next action-button"> Next
                            ...
                            <fieldset>
                                <div class="w-100 row">
                                    <div class="row ui-white-box">
                                        <div class="col-sm-12 job_title">
                                            ...
                                            <div class="col-sm-12 col-sm-offset-2 text-justify">
                                                <h5 class="text-center">E-COMMERCE PROFESSIONAL SERVICE PROVIDER
                                                    AGREEMENT</h5>
                                                <h6
                                                    class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold text-center">
                                                ...
                                                <p class="agreed-t-and-c-p">The Company, in its sole discretion, change
                                                    ...
                                                    (URL): <a
                                                        href="https://www.Easifyy.com">https://www.Easifyy.com.</a>
                                                ...
                                                <p class="agreed notes-p"><b>1.2</b>&nbsp;&nbsp;“Customer” shall mean
                                                ...
                                                <p class="agreed notes-p"><b>1.3</b>&nbsp;&nbsp;“Confidential
                                                ...
                                                <p class="agreed notes-p"><b>1.6</b>&nbsp;&nbsp;‘Intellectual Property
                                                ...
                                                <p class="agreed notes-p"><b>1.7</b>&nbsp;&nbsp;“The Professional
                                                    ...
                                                    permitted assigns.</p>
                                                <p class="agreed notes-p"><b>1.8</b>&nbsp;&nbsp;“Website”, “Portal”,
                                                ...
                                                <p class="agreed notes-p"><b>1.9</b>&nbsp;&nbsp;“Order” shall mean a
                                                ...
                                                <p class="agreed notes-p"><b>1.12</b>&nbsp;&nbsp;"Shipping Charges”
                                                    ...
                                                    Customer.</p>
                                                <p class="agreed notes-p"><b>1.13</b>&nbsp;&nbsp;“Handling charges”
                                                    ...
                                                    logistics.</p>
                                                <p class="agreed notes-p"><b>1.14</b>&nbsp;&nbsp;“Sign-up/registration
                                                ...
                                                <p class="agreed notes-p"> <b>1.15</b>&nbsp;&nbsp;“Service Fee” shall
                                                ...
                                                <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                    <b>3.</b>Consideration and Payment Terms :-
                                                </h6>
                                                ...
                                                <p class="agreed notes-p"><b>3.4</b>&nbsp;&nbsp;<b>The above said
                                                        payment
                                                        to the Professional Service Provider shall be done by Company in
                                                        the
                                                        following manner: </b></p>
                                                <p class="agreed notes-p"><b>3.4.1</b>&nbsp;&nbsp;he Professional
                                                    Service
                                                ...
                                                <p class="agreed notes-p"><b>3.4.2</b>&nbsp;&nbsp;The Company shall
                                                    within
                                                    ...
                                                    channels.</p>
                                                <p class="agreed notes-p"><b>3.4.3</b>&nbsp;&nbsp;The Professional
                                                    Service
                                                ...
                                                <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                    <b>4.</b>Obligations of the Professional Service Provider :-
                                                </h6>
                                                <p class="agreed notes-p"><b>4.1</b>&nbsp;&nbsp;Through the
                                                ...
                                                <p class="agreed notes-p"><b>4.2</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.3</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.4</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.5</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.6</b>&nbsp;&nbsp;On receipt of the
                                                    ...
                                                    Portal.</p>
                                                <p class="agreed notes-p"><b>4.7</b>&nbsp;&nbsp;In the event the
                                                ...
                                                <p class="agreed notes-p"><b>4.8</b>&nbsp;&nbsp;The Professional
                                                    ...
                                                    Company.</p>
                                                <p class="agreed notes-p"><b>4.9</b>&nbsp;&nbsp;The Professional
                                                    ...
                                                    order. </p>
                                                <p class="agreed notes-p"><b>4.10</b>&nbsp;&nbsp;The Professional
                                                    ...
                                                    and timely manner. </p>
                                                <p class="agreed notes-p"><b>4.11</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.12</b>&nbsp;&nbsp;The Professional
                                                    ...
                                                    Indian laws.</p>
                                                <p class="agreed notes-p"><b>4.13</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.16</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.17</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <p class="agreed notes-p"><b>4.18</b>&nbsp;&nbsp;The Professional
                                                    ...
                                                    agreement. </p>
                                                <p class="agreed notes-p"><b>4.19</b>&nbsp;&nbsp;The Professional
                                                    ...
                                                    Customer/company.</p>
                                                <p class="agreed notes-p"><b>4.20</b>&nbsp;&nbsp;The Professional
                                                ...
                                                <div id="show" style="display:none">
                                                    ...
                                                    <p class="agreed notes-p"><b>5.4</b>&nbsp;&nbsp;The Professional
                                                        Service
                                                        Provider holds all the requisite permissions, authorities,
                                                        approvals
                                                        ...
                                                        shall continue to discharge all their obligations towards
                                                        statutory
                                                        authorities.</p>
                                                    <p class="agreed notes-p"><b>5.5</b>&nbsp;&nbsp;The Professional
                                                        Service
                                                        Provider shall be solely responsible for the acts of its
                                                        personnel
                                                        and shall ensure that none of its personnel are indulging in any
                                                        acts which would be harmful to the reputation of the Company
                                                        and/or
                                                        indulging in any acts detrimental to the business of the Company
                                                        and/or involved in any unlawfully activity. </p>
                                                    <p class="agreed notes-p"><b>5.6</b>&nbsp;&nbsp;The Professional
                                                        Service
                                                        Provider shall provide the Company with copies of any document
                                                        required by the Company for the purposes of the Performance of
                                                        its
                                                        obligations under this arrangement within 24 hours of getting a
                                                        written notice from the Company.</p>
                                                    <p class="agreed notes-p"><b>5.7</b>&nbsp;&nbsp;During the term
                                                        hereof,
                                                        Professional Service Provider shall not, without the prior
                                                        written
                                                        approval of the Company, make any press release or other public
                                                        announcement concerning the Agreement, Documents or the
                                                        transactions
                                                        ...
                                                        Provider shall be solely responsible to the Customer for the
                                                        sale of
                                                        the Professional Service by The Professional Service Provider
                                                        including but not limited to its delivery to the Customer and
                                                        that
                                                        The Professional Service Provider shall not raise any claim on
                                                        the
                                                        Company in this regard.</p>
                                                    <p class="agreed notes-p"><b>5.8</b>&nbsp;&nbsp;The Professional
                                                        Service
                                                        Provider shall bear all the cost and related expenses to settle
                                                        any
                                                        Customer dispute or claims including but not limited to legal
                                                        proceedings, compensation, fines, penalties, charges, towards
                                                        any
                                                        such claim, damages, action or allegation incurred by the
                                                        Company
                                                        from the Customer related to the Professional Services and its
                                                        usage. </p>
                                                    <p class="agreed notes-p"><b>5.9</b>&nbsp;&nbsp;The Professional
                                                        Service
                                                        Provider agrees and undertakes not to upload any text, images,
                                                        graphics (for description and display of Professional Service on
                                                        the
                                                        Portal) that is but with limitation vulgar, Obnoxious,
                                                        inaccurate,
                                                        false, incorrect, misleading, intimidating, against the public
                                                        policy.</p>
                                                    <p class="agreed notes-p"><b>5.10</b>&nbsp;&nbsp;The Professional
                                                        Service Provider shall undertake to observe, adhere to, abide
                                                        by,
                                                        comply with and notify the Company about all laws and acts in
                                                        force
                                                        ...
                                                        shall indemnify, keep indemnified, hold harmless, defend and
                                                        protect
                                                        the Company and its employees/officers/staff
                                                        personnel/representatives/ from any failure or omission or
                                                        violation
                                                        or default or breach on its part to do so and against all claims
                                                        or
                                                        demands of liability and all consequences that may occur or
                                                        arise
                                                        for any default or failure on its part to conform or comply with
                                                        the
                                                        above and all other statutory obligations arising there from.
                                                    </p>
                                                    <p class="agreed notes-p"><b>5.11</b>&nbsp;&nbsp;The Professional
                                                        Service Provider shall pay the Company the service fee without
                                                        any
                                                        demur, counterclaim, setoff or delay and handling charge as
                                                        specified by the Company on every transaction and that the
                                                        Professional Service Provider shall provide all transaction
                                                        details
                                                    ...
                                                    <p class="agreed notes-p"><b>5.12</b>&nbsp;&nbsp;The Professional
                                                        ...
                                                        promotion/advertisement material seek prior written approval
                                                        that
                                                        may be withheld, delayed or refused for the same from the
                                                        Company,
                                                        in so far as the same relates to services offered pursuant to
                                                        the
                                                        terms of this Agreement.</p>
                                                    <p class="agreed notes-p"><b>5.13</b>&nbsp;&nbsp;The Agreement
                                                        Documents
                                                        and the rights and duties arising hereunder shall not be
                                                        assigned,
                                                        and the work to be provided by Professional Service Provider
                                                        thereunder shall not be subcontracted, without the Company’s
                                                        prior
                                                        written consent that may be refused or withheld. Any attempted
                                                        sale,
                                                    ...
                                                    <p class="agreed notes-p"><b>5.14</b>&nbsp;&nbsp;The Professional
                                                        Service Provider shall not use the customer details other than
                                                        to
                                                        execute the transaction under this agreement and the
                                                        Professional
                                                        Service Provider shall not share the same with any other party.
                                                    </p>
                                                    <p class="agreed notes-p"><b>5.15</b>&nbsp;&nbsp;The Professional
                                                        Service Provider shall ensure that descriptions, images and
                                                        other
                                                        contents pertaining to professional services on portal is
                                                        accurate
                                                        and corresponds directly with the appearance, nature, quality,
                                                        purpose and other general features of such professional service.
                                                    </p>
                                                    <p class="agreed notes-p"><b>5.16</b>&nbsp;&nbsp;The execution,
                                                        delivery
                                                        and performance of this Agreement by the Professional Service
                                                        Provider does not and will not: (1) require the consent of any
                                                        undisclosed person or entity, (2) violate any legal requirement
                                                        or
                                                        (3) conflict with, or constitute a breach or violation of (a)
                                                        its
                                                        entity’s organizational documents, if any, or (b) the terms or
                                                        provisions of any other agreement, instrument or understanding
                                                        by
                                                        which the Professional Service Provider is bound or affected.
                                                    </p>


                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>6.</b>Company Reserves the Right:-
                                                    </h6>
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>7.</b> ProfessionalServices Returns/Refund:
                                                    </h6>
                                                    <p class="agreed notes-p">&nbsp;&nbsp; Parties unconditionally agree
                                                        that the Company
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>9.</b> Company not Liable :-
                                                    </h6>
                                                    <p class="agreed notes-p"><b>9.1</b>&nbsp;&nbsp;
                                                        The Company, on the basis of representation and information
                                                        provided by the Professional Service Provider, has created the
                                                        account of the Professional Service Provider on the Portal to
                                                        enable The Professional Service Provider to offer the
                                                        Professional Service for sale through the said Portal. This
                                                        representation and information is the essence of the Contract.
                                                    </p>

                                                    <p class="agreed notes-p"><b>9.2</b>&nbsp;&nbsp;

                                                        The Company shall under no circumstances be liable or
                                                        responsible for any loss, injury or damage to the Professional
                                                        Service Provider, or any other party whomsoever, arising on
                                                        account of any transaction under this Agreement or as a result
                                                        of the Professional Service being in any way damaged, defective,
                                                        in unfit condition, infringing/ violating any laws / regulations
                                                        /intellectual property rights of any third party and the
                                                        Professional Service Provider agrees and acknowledges this.

                                                    </p>
                                                    <p class="agreed notes-p"><b>9.3</b>&nbsp;&nbsp;
                                                        The Professional Service Provider shall always be solely liable
                                                        for any claims, damages, allegation arising out of the
                                                        Professional Service offered for sale through its Portal
                                                        (including but not limited to quality, Fitness, quantity, price,
                                                        merchantability, use for a particular purpose, or any other
                                                        related claim) and shall always hold the Company harmless and
                                                        indemnified against all such claims and damages.
                                                    </p>
                                                    <p class="agreed notes-p"><b>9.4</b>&nbsp;&nbsp;
                                                        Further the Company shall not be liable for any claims, damages
                                                        arising out of any negligence, misconduct or misrepresentation
                                                        by the Professional Service Provider or any of its
                                                        representatives.
                                                    </p>
                                                    <p class="agreed notes-p"><b>9.5</b>&nbsp;&nbsp;
                                                        The Professional Service Provider hereby agrees, confirms and
                                                        acknowledges that the Professional Service is owned by the
                                                        Professional Service Provider and that the Company is merely a
                                                        facilitator for sale of the Professional Service Provider’s
                                                        Professional Service, hence the Company is not
                                                        responsible/liable for the Professional Service, its design,
                                                        including but not limited to its function and condition,
                                                        manufacturing and selling and financial obligations, warranties,
                                                        guarantees whatsoever. The Company reserves its right to state
                                                        appropriate Disclaimers or Terms & Conditions on the Portal.
                                                    </p>

                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>10.</b> Term, Termination and effects of Termination :-
                                                    </h6>
                                                    <p class="agreed notes-p"><b>10.1</b>&nbsp;&nbsp;<b> Term: </b>
                                                        ...
                                                        and binding</p>
                                                    <p class="agreed notes-p"><b>10.2</b>&nbsp;&nbsp;<b> This Agreement may
                                                        be terminated forthwith by the Company in the Event :-</b></p>
                                                    ...
                                                    <p class="agreed notes-p"><b>10.2.4</b>&nbsp;&nbsp;For any reason as
                                                        ...
                                                        <p class="agreed notes-p"><b>10.2.5</b>&nbsp;&nbsp;If the Professional Service Provider is in infringement of the third party rights including intellectual property rights.</p>
                                                    <p class="agreed notes-p"><b>10.2.6</b>&nbsp;&nbsp;This Agreement
                                                        may be terminated by either party giving the other 30 days
                                                        written notice.</p>
                                                    <p class="agreed notes-p"><b>10.3</b>&nbsp;&nbsp;<b>Effect of
                                                        Termination :- </b></p>
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>12.</b>Jurisdiction and Governing law :-
                                                    </h6>
                                                    <p class="notes-n-p">&nbsp;&nbsp;This Agreement and
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>14.</b> Intellectual Property Rights
                                                    </h6>
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>18.</b>Limitation of liability: -
                                                    </h6>
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>19.</b>Relationship of Parties :-
                                                    </h6>
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>22.</b>Corrupt and fraudulent practices
                                                    </h6>
                                                    ...
                                                    <p class="notes-n-p">This Agreement
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>25.</b> Violation of terms-
                                                    </h6>
                                                    <p class="notes-n-p">&nbsp;&nbsp;The
                                                    ...
                                                    <h6
                                                        class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold text-center mt-4 mb-4">
                                                    ...
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>3.</b> Standard Second Message
                                                    </h6>
                                                    
                                                        <p class="notes-n-p">&nbsp;&nbsp;<b>Share Documents checklist or Ask for Information:</b>
                                                    </p>
                                                    <p class="notes-n-p">&nbsp;&nbsp;Create a document checklist or
                                                        information checklist and send it to the Client on chat window.
                                                    </p>
                                                    <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>4.</b> Standard Third Message: Mention Delivery Time
                                                    </h6>
                                                    <ul>
                                                        ...
                                                        <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>5.</b> Next step is Creating
                                                        Milestones/Status:
                                                    </h6>   
                                                    <p class="notes-n-p p-0 m-0"></p>
                                                    <ul>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <h6 class="agreed-t-and-c-h3 text-voilet-dark font-weight-bold">
                                                        <b>9.</b>  Standard Replies to Client
                                                        Problems or Queries about the Portal:
                                                    </h6>   
                                                    <p class="notes-n-p p-0 m-0"></p> 
                                                    <ul>
                                                    ...
                                                    <p class="notes-n-p">&nbsp;&nbsp;The Professional Service Provider
                                                        ...
                                                        via an email to <a
                                                            href="mailto:welcome@easifyy.com">welcome@easifyy.com</a>
                                                    ...
                                                    <p class="notes-n-p">&nbsp;&nbsp;<b> Be kind and Responsive:</b> This is the foremost SOP which
                                                        ...
                                                        Providers agree to report the same via an email to <a
                                                            href="mailto:welcome@easifyy.com">welcome@easifyy.com</a> .
                                                    </p>
                                                    <p class="notes-n-p"><b>The Portal Disclaimer</b></p>
                                                    ...
                                                    <p class="notes-n-p">&nbsp;&nbsp;If you have any issues with respect
                                                        to these guidelines, please write to us at <a
                                                            href="mailti:welcome@easifyy.com">welcome@easifyy.com</a> .
                                                    </p>
                                                ...
                                                <div class="text-center">
                                                    <span class="more">Show more <i class="fa fa-angle-down"
                                                            aria-hidden="true"></i></span>
                                                    <span class="less" style="display:none">Show less <i
                                        ...
                                        <div class="col-sm-12 col-sm-offset-2">
                                            <h6 class="agreed-t-and-c-h1"><b>Declaration by Professional Service Provider:</b></h6>
                                            <div class="checkbox" style="margin-top: 25px;">
                                                <label style="font-size: 16px; color: #000;">
                                                    <?php echo $this->Form->checkbox('sop',['hiddenField' => false,'id'=>'sop','onclick'=>"$(this).attr('value', this.checked ? 1 : 0)",'readonly','disabled']);?>
                                                    I here by agree to the Terms of Use, Standard Operating Procedure,
                                                    Mandatory Guidelines and Easifyy Disclaimer.</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" name="previous" class="previous action-button-previous"><i
                                        class="fa fa-angle-left" aria-hidden="true"></i> Previous</button>
                                <button type="button" id="sop-btn" name="make_payment"
                                    class="profile-next action-button"> Next <i class="fa fa-angle-right"
                                        aria-hidden="true"></i></button>
                            </fieldset>
                            <fieldset>
                                <div class="form-card col-md-6 ml-auto mr-auto">
                                    <h4 class="fs-title text-center">Hello, Professional Service Provider (PSP)</h4>
                                    <br><br>
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 text-center">
                                            <div class="box-ani bounce-7"><a href="/admin/users/dashboard"><img
                                                        src="../../img/go.png" class="fit-image"></a></div>
                                        </div>
                                    </div> <br><br>
                                    <div class="row justify-content-center">
                                        <div class="col-8 text-center">
                                            <h5>Enjoy easifyy Services !</h5>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
