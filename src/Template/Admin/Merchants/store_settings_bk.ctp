        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card-text w-50 float-left p-1">
                    ...
                    <span>
                        <?php echo $this->Form->control('address_line_1', array( 'class' => 'form-control', 'placeholder' => __('Address line 1'), 'label' => false, 'div' => false )); ?>
                    </span>
                </div>
                <div class="card-text w-50 float-left p-1">
                    <label>Address line 2</label>
                    <span>
                        <?php echo $this->Form->control('address_line_2', array( 'class' => 'form-control', 'placeholder' => __('Address line 2'), 'label' => false, 'div' => false , 'required')); ?>
                    </span>
                </div>
                ...
                <div class="card-text w-50 float-left p-1">
                    ...
                    <span>
                        <?php echo $this->Form->control('phone_1', array( 'class' => 'form-control', 'placeholder' => __('Mobile'), 'label' => false, 'div' => false , 'required')); ?>
                    </span>
                </div>
                ...
                <div class="card-text w-50 float-left p-1">
                    ...
                    <span>
                        <?php echo $this->Form->control('phone_2', array( 'class' => 'form-control', 'placeholder' => __('Landline'), 'label' => false, 'div' => false , 'required')); ?>
                    </span>
                </div>
