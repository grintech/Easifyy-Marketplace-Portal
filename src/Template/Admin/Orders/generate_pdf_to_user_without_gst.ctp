...
$date= date("d/m/Y");//date_format($order->created, "d/m/Y");
// Set some content to print
$html = <<<EOD
<table cellpadding="2" border="1" width="100%"><tr align="center"><th colspan="18"><img src="https://easifyy.com/img/logo.png" alt="" width="100"></th></tr><tr align="center"><th colspan="18"><b>POWERED BY EASIFYY.COM</b></th></tr><tr align="center"><th colspan="18"><b> KISTEN EDUCATION PVT. LTD.</b></th></tr><tr align="center"><th colspan="18"><b>Address:</b> H-16/A/947, SANGAM VIHAR, NEW DELHI 110062</th></tr><tr><td colspan="6"><b>Phone No.:</b></td><td colspan="6"><b>Email:</b> welcome@easifyy.com</td><td colspan="6"><b>PAN:</b> AAECK0248H</td></tr><tr><td colspan="7"><b>GSTIN: </b> </td><td colspan="7"><b>State: </b> DELHI</td><td colspan="4"><b>Code:</b> 07</td></tr><tr><td colspan="12"><b>ORDER No.:</b>{$order->invoice_id}</td><td colspan="6"><b>ORDER DATE:</b>{$orderPlacedDate}</td></tr><tr align="center"><th colspan="18"><b>TAX INVOICE (Original for Receipient)</b></th></tr><tr><td colspan="12"><b>Invoice No.:</b>{$invoiceNo}</td><td colspan="6"><b>Invoice Date:</b>{$date}</td></tr><tr><td align="center" colspan="18"><b>CUSTOMER DETAILS</b></td></tr><tr><td colspan="12"><b>Name: </b>{$order->user->first_name}&nbsp;{$order->user->last_name}</td><td colspan="6"><b>PAN: </b>{$order->user->pan_number}</td></tr><tr><td colspan="18"><b>Address: </b>{$order->user->addresses[0]['address_line_1']}&nbsp;{$order->user->addresses[0]['address_line_2']}&nbsp;{$userCity}&nbsp;{$userState}&nbsp;{$order->user->addresses[0]['zip_code']}</td></tr><tr><td colspan="7"><b>GSTIN: </b>{$order->merchant->gst_number}</td><td colspan="7"><b>State: </b>{$userState}</td><td colspan="4"><b>Code:</b>{$userStateCode}</td></tr><tr><td colspan="7"><b>Phone No.:</b>{$order->user->phone}</td><td colspan="7"><b>Email</b> :{$order->user->username}</td><td colspan="4">Referral code</td></tr><tr><td colspan="2"><b>S.No.</b></td><td colspan="5"><b>Description</b></td><td colspan="2"><b>SAC Code</b></td><td colspan="3"><b>Non Taxable Amount (Rs.)</b></td><td colspan="3"><b>Taxable Amount (Rs.)</b></td><td colspan="3"><b>Total Amount (Rs.)</b></td></tr><tr><td colspan="2" align="center">1</td><td colspan="5">Consultancy & Service Fee -{$serviceName}</td><td colspan="2">{$sac_code}</td><td colspan="3"></td><td colspan="3" align="center">{$professionalFee}</td><td colspan="3" align="center">{$professionalFee}</td></tr><tr><td colspan="2" align="center">2</td><td colspan="5">{$gvtHeading1}</td><td colspan="2"></td><td colspan="3" align="center">{$gvtPrice1}</td><td colspan="3"></td><td colspan="3" align="center">{$gvtPrice1}</td></tr><tr><td colspan="2" align="center">3</td><td colspan="5">{$gvtHeading2}</td><td colspan="2"></td><td colspan="3" align="center">{$gvtPrice2}</td><td colspan="3"></td><td colspan="3" align="center">{$gvtPrice2}</td></tr><tr><td colspan="2" align="center">4</td><td colspan="5">{$gvtHeading3}</td><td colspan="2"></td><td colspan="3" align="center">{$gvtPrice3}</td><td colspan="3"></td><td colspan="3" align="center">{$gvtPrice3}</td></tr><tr><td colspan="2" align="center">5</td><td colspan="5">{$gvtHeading4}</td><td colspan="2"></td><td colspan="3" align="center">{$gvtPrice4}</td><td colspan="3"></td><td colspan="3" align="center">{$gvtPrice4}</td></tr><tr><td colspan="2" align="center">6</td><td colspan="5" align="center">{$gvtHeading5}</td><td colspan="2"></td><td colspan="3" align="center">{$gvtPrice5}</td><td colspan="3"></td><td colspan="3" align="center">{$gvtPrice5}</td></tr><tr><td rowspan="4" colspan="9" ><p style="text-align:center;"><br><br><b>Total Invoice amount in words :</b>{$totalAmountInwords}</p></td><td colspan="6"><b>Total Amount</b></td><td colspan="3" align="center">{$totalAmount}</td></tr><tr><td colspan="4">Referral Discount</td><td>{$couponCode}</td><td>%</td><td colspan="3" align="center">{$couponDiscount}</td></tr><tr><td colspan="6"><b>Total Amount before Tax</b></td><td colspan="3" align="center">{$totalAmount}</td></tr><tr><td colspan="4">Add: CGST @</td><td align="center">{$cGstPercntage}</td><td>%</td><td colspan="3" align="center">{$cGst}</td></tr><tr><td rowspan="4" colspan="9"> <br><br><br><br><p style="text-align:center;"><b>For <b>Kisten Education</b> Pvt. Ltd.</b></p></td><td colspan="4">Add: SGST @</td><td align="center">{$sGstPercntage}</td><td>%</td><td colspan="3" align="center">{$sGst}</td></tr><tr><td colspan="4">Add: IGST @</td><td align="center">{$iGstPercntage}</td><td>%</td><td colspan="3" align="center">{$iGst}</td></tr><tr><td colspan="6">Total Tax Amount</td><td colspan="3" align="center">0.00</td></tr><tr><td colspan="6"><b>Total Amount after Tax</b></td><td colspan="3" align="center">{$totalAmountwithDiscount}</td></tr><tr><td colspan="18" style="text-align:center;">This is a computer Generated Invoice therefore signature is not required</td></tr></table>
EOD;
