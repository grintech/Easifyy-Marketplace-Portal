...
<div class="cities view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Statecode') ?></th>
            <td><?= $this->Number->format($city->statecode) ?></td>
        </tr>
    </table>
    <div class="related">
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($city->merchants as $merchants): ?>
            <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($city->suppliers as $suppliers): ?>
            <tr>
