...
<div class="userLogs index large-9 medium-8 columns content">
    <h3><?= __('User Logs') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $userLog->has('user') ? $this->Html->link($userLog->user->id, ['controller' => 'Users', 'action' => 'view', $userLog->user->id]) : '' ?></td>
                <td><?= h($userLog->ip) ?></td>
