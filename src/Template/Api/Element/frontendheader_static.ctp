                    ...
                    <ul class="navbar-nav nav-fill w-100" id="main-nav">
                       ...
                       <?php
                            ...
                            foreach( $mainCate as $key => $brand ){
                                ...
                                if(trim($brand->name) =='E-Filling'){
                                    echo '<li class="nav-item dropdown position-static" id="superMenu">
                                            <a class="nav-link " href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'.trim($brand->name).'</a>';
                                                                                ...
                                                                                <ul class="list-unstyled">';
                                                                                    foreach( $subCate->product_categories as $key1 => $products ){
                                                                                        if($products->product->delete_status==1){
                                                                                            echo '<li><a class="text-dark" href="#">'.trim($products->product->title).'</a></li>';
                                                                                        }
                                                                                    }
                                                                    echo '      </ul>
                                                                        </div>';
