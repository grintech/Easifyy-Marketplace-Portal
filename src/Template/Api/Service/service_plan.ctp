    ...
    <div class="row">
        <div class="col-md-8">
              ...
              <div class="col-md-6">
                <div class="plan_section">
                  ...
                  <div class="view-details">
                    <a href="../service-details/<?php echo urlencode($service->product->slug)?>" class=" btn btn-save btn-block">View Packages</a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4">
            ...
            <div class="query1">
              <b class="query_1">Mindzpro Assurance</b>
              <div class="_1s7Acb">
                <ul>
                  ...
                  <li>MindzPro Dedicated Support</li>
                </ul>
              </div>
            </div>
            <div class="query1">
