     ...
     <div class="row text-center">
          <div class="col-md-12">
            ...
            <div class="description">
              <p >Get your business running. Launch your Startup at the lowest price. Pay just Rs 5,999 and get your private limited company incorporated.</p>
            </div>
       ...
       <div>
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="row services">
              ...
              <div class="col-md-9">
                ...
                <li><i class="fa fa-angle-right about-list-arrows"></i>App to manage your business Khata</li>
                <li><i class="fa fa-angle-right about-list-arrows"></i>Exclusive offers from our Partner</li>
                <ul class="list-display">
                  <li><i class="fa fa-angle-right about-list-arrows"></i>ICICI Bank</li>
                    <li><i class="fa fa-angle-right about-list-arrows"></i>Freshworks</li>
                </ul>
              </ul>
            </div>
             </div>
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <ul class="list-checkmarks">
                <li><i class="fa fa-angle-right about-list-arrows"></i>Businesses looking to expand or scale operations</li>
                <li><i class="fa fa-angle-right about-list-arrows"></i>Startups looking to raise capital and issue ESOPs</li>
                <li><i class="fa fa-angle-right about-list-arrows"></i>Businesses looking to convert their existing firm structure into private limited company</li>
              </ul>
            </div>
          </div>
          </div>
          <div class="tab-pane" id="work" role="tabpanel" aria-labelledby="info-tab">
            ...
            <div class="_1s7Acb">
              <ul>
                <li>Purchase of Plan</li>
                <li>DSC Application</li>
                <li>Company Name Reservation with RUN</li>
      ...
      <div class="col-md-5 card-body" style="padding: 0;">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active px-2" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <button <?php echo $myUrlBas?> class="btn btn-primary btn-block" <?php echo $mymodal ?> ><span style="font-weight:700;">Make Payment Rs.</span><span class="service-price" price="<?php echo h($service[0]->_basic_price)?>"><?php echo h($service[0]->_basic_price)?></span></button>
                ...
                <?php if($service[0]->_premium_price!=''){?>
                    <div class="tab-pane fade px-2" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        ...
                        <button <?php echo $myUrlPre?> class="btn btn-pay-installment btn-track-pay" <?php echo $mymodal ?> ><span style="font-weight: 700;">Make Pkayment Rs. </span><span class="service-price" > price="<?php echo h($service[0]->_premium_price)?>"><?php echo h($service[0]->_premium_price)?></span></button>
                        <p class="para text-center" style="margin: 0px;"><b>Or</b></p>
