                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="../assets/images/graphic.jpg" alt="card image"></p>
                                    <h4 class="card-title"style="text-transform: inherit;">
                                     <?php  echo $this->Html->link(
                    $service->product->title,
                    '/service/'.urlencode($service->product->slug),
                    ['class' => '']
                );?>
                                    </h4>
                                    
                                    <a href="#"> Service Price :<?=h($service->product->_basic_price)?>
                                      </a>
                                </div>
                            </div>
                        </div>
                        <div class="backside">
                            <div class="card bg-lightpurple">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="../assets/images/graphic1.jpg" alt="card image"></p>
                                   <h4 class="card-title" style="text-transform: inherit;">
                                     <?php  echo $this->Html->link(
                    $service->product->title,
                    '/service/'.urlencode($service->product->slug),
    ...
    <?php foreach ($services as $service): ?>
      <div class="w-16 about-in text-center">
          <div class="card h-100">
            ...
            <div class="description">Service Price :<?=h($service->product->_basic_price)?></div>
          </div>
      </div>
    <?php endforeach; ?>
  </div>
