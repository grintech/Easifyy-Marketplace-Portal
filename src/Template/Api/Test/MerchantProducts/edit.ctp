...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $merchantProduct->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $merchantProduct->id)]
            )
        ?></li>
...
<div class="merchantProducts form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('product_unit_id', ['options' => $productUnits, 'empty' => true]);
