...
<div class="merchantProducts view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $merchantProduct->has('product_unit') ? $this->Html->link($merchantProduct->product_unit->name, ['controller' => 'ProductUnits', 'action' => 'view', $merchantProduct->product_unit->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= h($merchantProduct->_hsn_code) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($merchantProduct->status) ?></td>
        </tr>
        <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($merchantProduct->cart_items)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($merchantProduct->cart_items as $cartItems): ?>
            <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($childMerchantProducts->product_unit_id) ?></td>
                <td><?= h($childMerchantProducts->_stock) ?></td>
                <td><?= h($childMerchantProducts->_bar_code) ?></td>
                <td><?= h($childMerchantProducts->_hsn_code) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($merchantProduct->order_items)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($merchantProduct->order_items as $orderItems): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($merchantProduct->wishlists)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Merchant Id') ?></th>
            ...
            <?php foreach ($merchantProduct->wishlists as $wishlists): ?>
            <tr>
