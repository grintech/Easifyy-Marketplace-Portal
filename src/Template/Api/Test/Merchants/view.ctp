...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Merchant Galleries'), ['controller' => 'MerchantGalleries', 'action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Merchant Gallery'), ['controller' => 'MerchantGalleries', 'action' => 'add']) ?> </li>
...
<div class="merchants view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Delivery Slot') ?></th>
            <td><?= h($merchant->delivery_slot) ?></td>
        </tr>
        <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($cartItems->merchant_product_id) ?></td>
    ...
    <div class="related">
        <h4><?= __('Related Merchant Galleries') ?></h4>
        <?php if (!empty($merchant->merchant_galleries)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Merchant Id') ?></th>
            ...
            <?php foreach ($merchant->merchant_galleries as $merchantGalleries): ?>
            <tr>
                <td><?= h($merchantGalleries->id) ?></td>
                <td><?= h($merchantGalleries->merchant_id) ?></td>
                <td><?= h($merchantGalleries->type) ?></td>
                <td><?= h($merchantGalleries->url) ?></td>
                <td><?= h($merchantGalleries->created) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'MerchantGalleries', 'action' => 'view', $merchantGalleries->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['controller' => 'MerchantGalleries', 'action' => 'edit', $merchantGalleries->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'MerchantGalleries', 'action' => 'delete', $merchantGalleries->id], ['confirm' => __('Are you sure you want to delete # {0}?', $merchantGalleries->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Product Unit Id') ?></th>
            ...
            <tr>
                ...
                <td><?= h($merchantProducts->product_unit_id) ?></td>
                <td><?= h($merchantProducts->_stock) ?></td>
                <td><?= h($merchantProducts->_bar_code) ?></td>
                <td><?= h($merchantProducts->_hsn_code) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($merchant->suppliers)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Merchant Id') ?></th>
            ...
            <?php foreach ($merchant->suppliers as $suppliers): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($merchant->wishlists)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Merchant Id') ?></th>
            ...
            <?php foreach ($merchant->wishlists as $wishlists): ?>
            <tr>
                <td><?= h($wishlists->id) ?></td>
                <td><?= h($wishlists->merchant_id) ?></td>
                <td><?= h($wishlists->user_id) ?></td>
                <td><?= h($wishlists->merchant_product_id) ?></td>
                <td><?= h($wishlists->sessionID) ?></td>
