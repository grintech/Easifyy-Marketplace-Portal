...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Delivery Addresses'), ['controller' => 'DeliveryAddresses', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('New Delivery Address'), ['controller' => 'DeliveryAddresses', 'action' => 'add']) ?></li>
...
<div class="orders form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('delivery_address_id', ['options' => $deliveryAddresses, 'empty' => true]);
