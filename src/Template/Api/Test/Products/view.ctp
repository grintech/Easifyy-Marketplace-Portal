...
<div class="products view large-9 medium-8 columns content">
    ...
    <div class="related">
        <h4><?= __('Related Product Bundled Items') ?></h4>
        <?php if (!empty($product->product_bundled_items)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($product->product_bundled_items as $productBundledItems): ?>
            <tr>
                <td><?= h($productBundledItems->id) ?></td>
                <td><?= h($productBundledItems->bundled_parent) ?></td>
                <td><?= h($productBundledItems->product_id) ?></td>
                <td><?= h($productBundledItems->price) ?></td>
                <td><?= h($productBundledItems->quantity) ?></td>
                <td><?= h($productBundledItems->total_price) ?></td>
                <td><?= h($productBundledItems->created) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'ProductBundledItems', 'action' => 'view', $productBundledItems->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['controller' => 'ProductBundledItems', 'action' => 'edit', $productBundledItems->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'ProductBundledItems', 'action' => 'delete', $productBundledItems->id], ['confirm' => __('Are you sure you want to delete # {0}?', $productBundledItems->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($childProducts->_hsn_code) ?></td>
