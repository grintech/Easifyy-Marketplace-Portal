              ...
              <div class="col-lg-6 col-md-6">
                ...
                <div class="form-group input-group">
                  ...
                  <div class="form-group input-group">
                    ...
                    <input name="phone" class="form-control" placeholder="Pin code" type="text">
                  </div> 
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"> <i class="fa fa-credit-card"></i> </span>
                    </div>
                    <input name="phone" class="form-control" placeholder="Practising Registration/License Number" type="text">
                  </div>
                  <div class="form-group input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"> <i class="fa fa-university"></i> </span>
                    </div>
                <input name="phone" class="form-control" placeholder="Name of Institute" type="text">
                </div> 
              </div>
              <div class="col-lg-6 col-md-6">
