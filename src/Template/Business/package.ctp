        ...
        <div class="card bg-light px-4">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <!--<article class="card-body">-->
                    <br>
                    <?= $this->Form->create(NULL, array('url'=>'/business/savepackagequery')) ?>
                    <div class="row">
                        <input type="text" hidden name="business-package" value="<?=$title?>"/>
                        ...
                        <!--<div class="form-group input-group col-md-6 col-xs-12" >
                         ...
                         <div class="form-group input-group col-md-12 col-xs-12">
                            ...
                            <?php echo $this->Form->textarea('comment',['rows' => '4', 'cols' => '50' ,'placeholder'=>'Enter your message here' ,'class'=>'business-textarea col-md-12']);?>
							              <!--<textarea rows="4" class="form-control" cols="50" name="comment" form="usrform" placeholder="Enter text here..."></textarea>-->
                        </div>  
