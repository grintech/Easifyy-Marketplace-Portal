...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
  <div class="brand-sidebar">
    <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="<?= $this->Url->build( [ 'controller' => 'Users', 'action' => 'dashboard']) ?>"><span class="logo-text hide-on-med-and-down"><?php echo __('Market Place Portal'); ?> </span></a><a class="navbar-toggler" href="#"></a></h1>
  </div>
 ...
 -->
    ...
    <li class="bold <?= $active ?>">
      <a class="collapsible-header waves-effect waves-cyan " href="javascript:void(0)"><i class="material-icons">face</i><span class="menu-title" data-i18n=""><?php echo __('Profile'); ?></span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          <li>
            <?= $this->Html->link(__('Store Settings'), [ 'controller' => 'Merchants', 'action' => 'storeSettings']) ?>
          </li>
          <li>
              <?= $this->Html->link(__('Bank Details'), [ 'controller' => 'Merchants', 'action' => 'bankDetails']) ?>
          </li>
        </ul>
      </div>
    </li>
    ...
    <li class="bold <?= $active ?> <?= strtolower($this->request->getParam('controller')) ?>"><a class="collapsible-header waves-effect waves-cyan " href="javascript:void(0)"><i class="material-icons">local_grocery_store</i><span class="menu-title" data-i18n=""><?php echo __('Services'); ?></span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          ...
          <li>
              <?= $this->Html->link(__('Add New Services'), [ 'controller' => 'MerchantProducts', 'action' => 'addCustomProduct']) ?>
          </li>
        </ul>
      </div>
    </li>
 ...
 <?php
    ...
    ?>
    <li style="display: none;" class="bold <?= $active ?>"><a class="collapsible-header waves-effect waves-cyan " href="javascript:void(0)"><i class="material-icons">local_mall</i><span class="menu-title" data-i18n=""><?php echo __('Orders'); ?></span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          <li>
