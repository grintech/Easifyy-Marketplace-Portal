...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
  <div class="brand-sidebar">
    <a class="px-3" href="../../">
      <?php echo $this->Html->image('easifyy-logo.png', ['alt' => 'mindzpro', 'width'=>"200"]);?>
    </a>
 ...
 -->
    ...
    ?>
    <li style="" class="bold <?= $active ?>">
      <a class="collapsible-header waves-effect waves-cyan " href="javascript:void(0)"><i class="material-icons">local_atm</i><span class="menu-title" data-i18n=""><?php echo __('Transactions'); ?></span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          <li>
