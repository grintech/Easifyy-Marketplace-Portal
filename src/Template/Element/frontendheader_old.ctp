                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dots-menu rounded">
                                <?php if ($this->Session->read('Auth.User')){
                                        echo '<li><a href="../users/signout" ><i class="fa fa-sign-out" aria-hidden="true"></i> LogOut</a></li>
                                        <li><a href="#" ><i class="fa fa-user" aria-hidden="true"></i> Profile</a> </li> ';
                                }else{
                                    echo '<li><a href="#" class="abc" myModal="id01" ><i class="fa fa-user" aria-hidden="true"></i> Login</a></li>

                                        <li><a href="#"class="abc" myModal="id02" ><i class="fa fa-sign-in" aria-hidden="true"></i> Sign Up</a></li>';
                                }?>
                                   ...
                                   <!-- <form class="modal-content animate" action="#" method="post">-->
                                    <?= $this->Form->create(NULL, array('url'=>'/users/chklogin','class'=>'modal-content animate')) ?>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <?php echo $this->Form->text('username',['class' => 'form-control', 'placeholder' => "User name" ]);?>
                                        </div>
                                        <div class="form-group">
