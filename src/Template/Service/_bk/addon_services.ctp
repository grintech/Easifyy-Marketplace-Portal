...
?>
<style type="text/css">
   @media (min-width: 275px) and (max-width:384px){
.main-cont {
    margin-top: 31%;
}
}
 @media (min-width: 385px) and (max-width: 468px){
.main-cont {
    margin-top: 28%;
}
}
 @media (min-width: 469px) and (max-width: 510px){
.main-cont {
    margin-top: 22%;
}
}
            ...
            <div class="card-body">
              ...
              <h5 class="card-title mb-3">
                <?php  echo $this->Html->link(
                    $service->name,
                    '/services/'.$mainService.'/'.urlencode($service->name),
                    ['class' => '']
                );?>
              </h5>
            </div>
