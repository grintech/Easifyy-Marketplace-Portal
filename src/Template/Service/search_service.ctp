            ...
            <?php $count=1; foreach ($services as $service): ?>
              <div class="col-md-6">
                <div class="plan_section">
                  ...
                  <?php 
                    $totalPrice=$service->_basic_price;
                    $discountedPrice=$service->_basic_plan_price;
                    $service_INC=$service->service_coverd;
                    //dd($service_INC);
                    if($totalPrice==0){
                  ...
                  ?>
                  <!--<p class="plan_price"><b>Rs <?=h($service->_basic_price)?>/-</b> <span class="_content-text">Original <strike>Rs 17,000</strike>(41.18% OFF)</span></p>-->
                  ...
                  <div class="view-details">
                    <a href="../service-details/<?php echo urlencode($service->slug)?>" class=" btn btn-save btn-block">View Packages</a>
                  </div>
                </div>
              </div>
            ...
            <div class="query bg-lightpurple">
              ...
              <form>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="pass" placeholder="Phone-Number">
                </div>
                <div class="form-group">
                  <a href="#" class=" btn btn-callback btn-default btn-block">Request a callback</a>
                </div>
              </form>
            </div> 
            <div class="query1">
