            ...
            <div class="card px-0 pt-0 pb-0 mt-0 mb-0">
                ...
                <div class="row mx-0">
                    <div class="col-md-12 mx-0">
                        ...
                        <fieldset>
                            <div class="form-card service-select-form">
                                <?= $this->Form->create($merchant, array('url'=>'/admin/merchants/store-settings','id' => 'profile-settings' ,'class'=>'row')) ?>
                                    ...
                                    <?php echo $this->Form->control('name_prefix', array( 'id'=>'name_prefix','class' => 'form-control col-md-12', 'placeholder' => __('Gender'), 'label' => "Gender", 'div' => false )); ?>
                                    <?php  echo $this->Form->hidden('type', ['value'=>'superadmin']); ?>
                                    <?php  echo $this->Form->hidden('id', ['value'=>$merchant->id]); ?>
                                    <?php echo $this->Form->control('store_name', array( 'id'=>'store_name','class' => 'form-control col-md-12', 'placeholder' => __('First Name'), 'label' => "First Name", 'div' => false )); ?>
                                    <?php echo $this->Form->control('last_name', array( 'id'=>'last_name','class' => 'form-control col-md-12', 'placeholder' => __('Last Name'), 'label' => "Last Name", 'div' => false )); ?>
                                    ...
                                    <?php echo $this->Form->control('state_id', array('type'=>'select', 'id'=>'states','required' => "required",'div' => false, 'label' => 'State *','class' => "browser-default",'options'=>$states ) ); ?>
                        ...
                        <fieldset>
                            <div class="form-card service-select-form">
                                <?= $this->Form->create($merchantKyc, array('url'=>'https://easifyy.com/superadmin/merchants/updateMerchantKyc','id' => 'kyc-details','enctype'=>'multipart/form-data')) ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($merchantKyc->govt_Id!="") {?>
                                            <a class=" col-md-2 py-5" href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->govt_Id?>" download><i class="fa fa-download"></i> <?=$merchantKyc->govt_Id?></a>

                                            <!--<img class="w-20 col-md-2 px-0 py-4" src="/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->govt_Id?>" width="200px"></img>-->
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-10 float-left p-1">
                                        ...
                                        <?php if($merchantKyc->address_Id!="") {?>
                                            <a class=" col-md-2 py-5" href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->address_Id?>" download><i class="fa fa-download"></i> <?=$merchantKyc->address_Id?></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($merchantKyc->qualification_Id!="") {?>
                                            <a class=" col-md-2 py-5" href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->qualification_Id?>" download><i class="fa fa-download"></i> <?=$merchantKyc->qualification_Id?></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($merchantKyc->gst_declarartion!="") {?>
                                            <a class=" col-md-2 py-5" href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->gst_declarartion?>" download><i class="fa fa-download"></i> <?=$merchantKyc->gst_declarartion?></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($merchantKyc->bank_cheque!="") {?>
                                            ...
                                            <a class=" col-md-2 py-5" href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->bank_cheque?>" download><i class="fa fa-download"></i> <?=$merchantKyc->bank_cheque?></a>
                                        <?php }?>
                                    </div>
                                    <div class="row">
                                        <div class="card-text w-80 col-md-10 float-left p-1">
                                        ...
                                        <?php if($merchantKyc->signature!="") {?>
                                            ...
                                            <a class=" col-md-2 py-5" href="https://easifyy.com/img/kyc-documents/<?=$merchantKyc->merchant_id?>/<?=$merchantKyc->signature?>" download><i class="fa fa-download"></i> <?=$merchantKyc->signature?></a>
                                        <?php }?>
                                    </div>
                                <div class="col-md-12">
                            ...
                            <button type="button" name="previous" class="previous action-button-previous"><i class="fa fa-angle-left" aria-hidden="true"></i> Previous</button>
                            <button type="button" name="next" class="action-button final-submit" id="<?= $merchant->id; ?>"> Save & Continue </button>
                        </fieldset>
                    <!--<fieldset>
                            <div class="w-100 row">
...
<script>
    $( document ).ready(function() {
        $( ".final-submit" ).on( "click", function() {     
            var id=$(this).attr('id'); // or alert();
            location.href = '/superadmin/merchants/edit/'+id+'/?type=s';
        });
    });
    </script>