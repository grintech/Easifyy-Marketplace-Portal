 ...
 * CategoriesBpFixture
 */
class CategoriesBpFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-01-21 04:48:54',
                'modified' => '2020-01-21 04:48:54',
            ],
        ];
        parent::init();
    }
