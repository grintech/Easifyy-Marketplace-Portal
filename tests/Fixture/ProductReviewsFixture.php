...
class ProductReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reviewer_name' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null],
        'review_text' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'rating' => 1,
                'created_at' => '2021-04-05 12:33:06',
            ],
        ];
        parent::init();
    }
