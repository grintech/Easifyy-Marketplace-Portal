...
class YoutubeVideosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'youtubeLink' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'youtubeLink' => 'Lorem ipsum dolor sit amet',
                'created_at' => '2021-05-14 12:40:33',
            ],
        ];
        parent::init();
    }
